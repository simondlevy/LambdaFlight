...
typedef enum {
    ...
    COPILOT_MODE_RUN_CORE,
    COPILOT_MODE_KALMAN_INIT,
    COPILOT_MODE_KALMAN_PREDICT,
    COPILOT_MODE_KALMAN_UPDATE,
    COPILOT_MODE_KALMAN_FINALIZE,
    COPILOT_MODE_KALMAN_GET_STATE
