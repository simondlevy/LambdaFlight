        ...
        float invSampleFreq) 
{
    ...
    auto qDot1 = 0.5f * (-q1 * gx - q2 * gy - q3 * gz);
    auto qDot2 = 0.5f * (q0 * gx + q2 * gz - q3 * gy);
    auto qDot3 = 0.5f * (q0 * gy - q1 * gz + q3 * gx);
    auto qDot4 = 0.5f * (q0 * gz + q1 * gy - q2 * gx);
    ...
    if(!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
        ...
        auto s1 = _4q1 * q3q3 - _2q3 * ax + 4.0f * q0q0 * q1 - _2q0 * ay - _4q1 +
            _8q1 * q1q1 + _8q1 * q2q2 + _4q1 * az; 
        auto s2 = 4.0f * q0q0 * q2 + _2q0
    ...
    auto recipNorm = invSqrt(q0 * q0 + q1 * q1 + q2 * q2 + q3 * q3);
    q0 *= recipNorm;
    q1 *= recipNorm;
    q2 *= recipNorm;
    q3 *= recipNorm;
