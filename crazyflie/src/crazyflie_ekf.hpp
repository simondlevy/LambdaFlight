...
class CrazyflieEkf : public Ekf {
    ...
    private:
                ...
                float Fdat[EKF_N][EKF_N]) override
        {
            ...
            Fdat[STATE_E0][STATE_E0] =  1 - e1*e1/2 - e2*e2/2;
            Fdat[STATE_E0][STATE_E1] =  e2 + e0*e1/2;
            Fdat[STATE_E0][STATE_E2] = -e1 + e0*e2/2;

            Fdat[STATE_E1][STATE_E0] =  -e2 + e0*e1/2;
            Fdat[STATE_E1][STATE_E1] = 1 - e0*e0/2 - e2*e2/2;
            Fdat[STATE_E1][STATE_E2] = e0 + e1*e2/2;

            Fdat[STATE_E2][STATE_E0] = e1 + e0*e2/2;
            Fdat[STATE_E2][STATE_E1] = -e0 + e1*e2/2;
            Fdat[STATE_E2][STATE_E2] = 1 - e0*e0/2 - e1*e1/2;

            // altitude from body-frame velocity
            Fdat[STATE_Z][STATE_DX] = _r.x*dt;
            Fdat[STATE_Z][STATE_DY] = _r.y*dt;
            ...
            Fdat[STATE_DY][STATE_DX] =  -_gyro.z*dt;
            Fdat[STATE_DZ][STATE_DX] = _gyro.y*dt;

            Fdat[STATE_DX][STATE_DY] = _gyro.z*dt;
            Fdat[STATE_DY][STATE_DY] = 1; //drag negligible
            Fdat[STATE_DZ][STATE_DY] = _gyro.x*dt;

            Fdat[STATE_DX][STATE_DZ] =  _gyro.y*dt;
            Fdat[STATE_DY][STATE_DZ] = _gyro.x*dt;
            Fdat[STATE_DZ][STATE_DZ] = 1; //drag negligible

            // body-frame velocity from attitude error
            Fdat[STATE_DX][STATE_E0] = 0;
            Fdat[STATE_DY][STATE_E0] = -MSS_TO_GS*_r.z*dt;
            Fdat[STATE_DZ][STATE_E0] = MSS_TO_GS*_r.y*dt;

            Fdat[STATE_DX][STATE_E1] = MSS_TO_GS*_r.z*dt;
            Fdat[STATE_DY][STATE_E1] = 0;
            Fdat[STATE_DZ][STATE_E1] = -MSS_TO_GS*_r.x*dt;
